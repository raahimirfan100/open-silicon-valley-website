    ...
    <section aria-labelledby="leadership-heading" className="py-24 bg-white">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16 max-w-3xl mx-auto">
          ...
          <h2 id="leadership-heading" className="text-3xl md:text-4xl font-bold mb-6">
            Leadership Team
          </h2>
          <p className="text-gray-600 text-pretty">
            Our dedicated volunteers bring diverse expertise and passion to build a stronger
            community and create opportunities for Pakistani entrepreneurs.
          </p>
        </div>
        ...
        <div className="text-center mt-16">
          <Button asChild className="rounded-full px-8">
            <Link href="/about/executive-team" className="flex items-center gap-2">
              View All Team Members <ArrowRight className="h-4 w-4" aria-hidden="true" />
            </Link>
          </Button>
        </div>
      </div>
