        ...
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col md:flex-row gap-12 items-center mb-16">
            ...
            <div className="md:w-1/2">
              ...
              <p className="text-gray-600 mb-6 text-pretty">
                The Organization of Pakistani Entrepreneurs is a global network spanning 15 cities
                from Silicon Valley to New York, London, and Islamabad. Our Silicon Valley chapter
                sits at the heart of technology innovation, fostering a vibrant community of
                entrepreneurs.
              </p>

              <p className="text-gray-600 mb-8 text-pretty">
                For over 24 years, OPEN has established itself as the premier platform for
                entrepreneurs, investors and professionals to network, collaborate, and mentor each
                other, helping countless professionals showcase their businesses to investors and
                create successful entrepreneurial ventures.
              </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-20">
            <div className="bg-gray-50 p-8 rounded-xl shadow-xs hover:shadow-md transition-all duration-300 card-hover border border-gray-100 h-full">
              <div
                className="p-3 rounded-full bg-primary/10 text-primary inline-block mb-6"
                aria-hidden="true"
              >
              ...
              <p className="text-gray-600 text-pretty">
                We strive to foster entrepreneurship and accelerate business development through
                workshops and forums where entrepreneurs and investors network and share ideas
                globally through our cross-chapter programs.
              </p>
            </div>
            ...
            <div className="bg-gray-50 p-8 rounded-xl shadow-xs hover:shadow-md transition-all duration-300 card-hover border border-gray-100 h-full">
              ...
              <p className="text-gray-600 text-pretty">
                ...
                obstacles. We facilitate entrepreneurship, create growth opportunities, provide
                mentorship, and develop events that empower and recognize accomplishments.
              </p>
            </div>
          </div>
