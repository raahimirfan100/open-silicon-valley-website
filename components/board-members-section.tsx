...
export default function BoardMembersSection() {
  ...
  return (
    <section aria-labelledby="board-heading" className="py-24 bg-gradient-to-b from-white to-gray-50">
      <div className="container mx-auto px-4">
        <div className="text-center mb-20 max-w-4xl mx-auto">
          ...
          <h2
            id="board-heading"
            className="text-4xl md:text-5xl font-bold mb-8 bg-gradient-to-r from-gray-900 to-gray-600 bg-clip-text text-transparent"
          >
            Board of Directors
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
            {featuredBoardMembers.map((member, index) => (
              <div key={index} className="group">
                <div className="bg-white rounded-2xl shadow-sm hover:shadow-2xl transition-all duration-500 border border-gray-100 h-full overflow-hidden relative">
                  {/* Prestigious background pattern */}
                  <div className="absolute top-0 right-0 w-32 h-32 opacity-5">
                    <div className="w-full h-full bg-gradient-to-br from-primary to-primary/50 rounded-full transform translate-x-16 -translate-y-16"></div>
                  </div>

                  <div className="p-8 flex flex-col items-center text-center h-full relative z-10">
                    <div className="relative mb-8">
                      <div className="absolute -inset-4 bg-gradient-to-r from-primary/20 to-primary/10 rounded-full opacity-0 group-hover:opacity-100 transition-all duration-500 blur-xl"></div>
                    ...
                    <div className="flex-grow">
                      ...
                      <p className="text-gray-600 leading-relaxed mb-6 flex-grow">{member.description}</p>
                    </div>
        ...
        <div className="text-center">
          <div className="bg-gradient-to-r from-primary/5 via-white to-primary/5 rounded-2xl p-8 border border-primary/10 max-w-2xl mx-auto">
