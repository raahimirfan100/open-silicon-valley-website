    ...
    <div className="container mx-auto px-4">
      <div className="text-center mb-12">
        ...
        <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
          We offer a variety of programs designed to support entrepreneurs and innovators at every
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        <Card>
          ...
          <CardContent>
            <p className="mb-6">
              Our 12-week accelerator program provides funding, mentorship, workspace, and
              connections to help startups validate their business models and prepare for growth.
            </p>
        ...
        <Card>
          ...
          <CardContent>
            <p className="mb-6">
              We connect established companies with startups and researchers to solve industry
              challenges through collaborative innovation projects.
            </p>
            <Button asChild variant="outline" className="w-full">
        ...
        <Card>
          ...
          <CardContent>
            <p className="mb-6">
              A 6-month program providing guidance, resources, and community for first-time founders
