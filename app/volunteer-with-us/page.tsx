    ...
    <div className="bg-white">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-600 mb-8">
              Join our team of dedicated volunteers and help make a difference in the
            ...
            <div className="flex flex-col md:flex-row gap-12 items-center">
              ...
              <div className="md:w-1/2">
                ...
                <p className="text-lg text-gray-600 mb-6">
                  OPEN Silicon Valley is a volunteer-led organization. Our success depends on the
                  dedication and skills of our volunteers. Join our team and help build a stronger
                  community while developing your skills and expanding your network.
                </p>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">
                        Gain valuable experience and skills that can enhance your professional
                        profile.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">
                        Contribute to the growth and success of the Pakistani entrepreneurial
                        ecosystem.
                      </p>
                    </div>
                  </div>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                Join one of our committees and contribute to specific areas of OPEN's mission.
              </p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <Card className="border-gray-100 text-center p-6">
                ...
                <p className="text-sm text-gray-600 mb-4">
                  Plan and execute all OPEN events including mixers, conferences, and workshops.
                </p>
              ...
              <Card className="border-gray-100 text-center p-6">
                ...
                <p className="text-sm text-gray-600 mb-4">
                  Focus on member recruitment, engagement, and retention strategies.
                </p>
                <div className="text-xs text-gray-500">
              ...
              <Card className="border-gray-100 text-center p-6">
                ...
                <p className="text-sm text-gray-600 mb-4">
                  Develop educational content, workshops, and professional development programs.
                </p>
                <div className="text-xs text-gray-500">
                  <div>Monthly meetings</div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold mb-4">Flexible Time Commitments</h2>
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                We offer various levels of involvement to fit your schedule and availability.
              </p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <Card className="border-gray-100 text-center p-6">
                ...
                <div className="text-2xl font-bold text-yellow-600 mb-2">2-4 hours</div>
              ...
              <Card className="border-gray-100 text-center p-6 border-primary">
                ...
                <div className="text-2xl font-bold text-primary mb-2">5-10 hours/month</div>
                <p className="text-sm text-gray-600">
              ...
              <Card className="border-gray-100 text-center p-6">
                ...
                <div className="text-2xl font-bold text-orange-600 mb-2">10+ hours/month</div>
                <p className="text-sm text-gray-600">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                We have various volunteer opportunities available based on your skills, interests,
                and availability.
              </p>
            </div>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold mb-4">Volunteer Recognition Program</h2>
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                We deeply appreciate our volunteers and recognize their valuable contributions in
                multiple ways.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <Card className="border-gray-100 shadow-xs p-6">
                <div className="flex flex-col items-center text-center">
                  ...
                  <p className="text-gray-600 italic mb-4">
                    "Volunteering with OPEN SV has been an incredible experience. I've met amazing
                    people, developed new skills, and made a real impact in the community. It's been
              ...
              <Card className="border-gray-100 shadow-xs p-6">
                <div className="flex flex-col items-center text-center">
                  ...
                  <p className="text-gray-600 italic mb-4">
                    "As a marketing volunteer, I've had the opportunity to work on meaningful
                    projects that have helped me grow professionally. The OPEN SV team is supportive
                    and appreciative of volunteers' contributions."
                  </p>
              ...
              <Card className="border-gray-100 shadow-xs p-6">
                <div className="flex flex-col items-center text-center">
                  ...
                  <p className="text-gray-600 italic mb-4">
                    "Volunteering with OPEN SV has expanded my network and opened doors to new
                    opportunities. I've made valuable connections and gained insights into the
            ...
            <div className="space-y-6">
              <Card className="border-gray-100 shadow-xs">
                <CardContent className="p-6">
                  ...
                  <p className="text-gray-600">
                    No, you don't need to be a member to volunteer with OPEN Silicon Valley.
                    However, many of our volunteers choose to become members to take advantage of
                    additional benefits.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="border-gray-100 shadow-xs">
                <CardContent className="p-6">
                  ...
                  <p className="text-gray-600">
                    The time commitment varies depending on the role and your availability. Most
                    volunteer roles require 3-10 hours per month, but we're flexible and appreciate
              ...
              <Card className="border-gray-100 shadow-xs">
                <CardContent className="p-6">
                  ...
                  <p className="text-gray-600">
                    Yes, many of our volunteer roles can be performed remotely. Some roles,
                    particularly those related to event management, may require occasional in-person
                    attendance.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="border-gray-100 shadow-xs">
                <CardContent className="p-6">
                  ...
                  <p className="text-gray-600">
                    We typically ask for a minimum commitment of 6 months, but this is flexible. We
                    understand that circumstances change and appreciate any time you can contribute.
                  </p>
                </CardContent>
              </Card>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg text-gray-600 mb-8">
              Join our team of dedicated volunteers and help us build a stronger community for
