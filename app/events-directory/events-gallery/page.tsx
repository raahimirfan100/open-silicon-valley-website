...
export default function EventsGalleryPage() {
  ...
  const eventCategories = [
    ...
    { id: "annual-forum", label: "Annual Forum" },
    { id: "workshops", label: "Workshops" },
    { id: "networking", label: "Networking" },
    { id: "women-forum", label: "Women Forum" },
  ]
      ...
      <section className="relative py-20 bg-gradient-to-b from-gray-50 to-white overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">Events Gallery</h1>
            <p className="text-xl text-gray-600 mb-8">
              Browse through photos from our past events. These images capture the energy, connections, and learning
              that happen at OPEN Silicon Valley gatherings.
            </p>
          </div>
        </div>
          ...
          <div className="max-w-6xl mx-auto">
              ...
              {eventCategories.map((category) => (
                <TabsContent key={category.id} value={category.id}>
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                    {galleryImages
                      .filter((image) => category.id === "all" || image.category === category.id)
                      .map((image) => (
                        <div key={image.id} className="group relative overflow-hidden rounded-lg shadow-sm">
                          ...
                          <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/40 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col justify-end p-4">
                            <div className="text-white">
                              ...
                              <div className="text-sm text-white/80">{image.year}</div>
                            </div>
                          </div>
                        </div>
                      ))}
            ...
            <div className="text-center mt-12">
              <p className="text-lg text-gray-600 mb-8">
                Want to see more photos from our events? Follow us on social media for the latest updates and event
                announcements.
              </p>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg text-gray-600 mb-8">
              Don't miss out on the opportunity to connect with fellow entrepreneurs, investors, and professionals at
              our upcoming events.
            </p>
