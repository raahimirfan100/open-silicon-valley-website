        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-600 mb-8">
              Browse through photos from our past events. These images capture the energy,
              connections, and learning that happen at OPEN Silicon Valley gatherings.
            </p>
          </div>
        </div>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="text-center mt-12">
              <p className="text-lg text-gray-600 mb-8">
                Want to see more photos from our events? Follow us on social media for the latest
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg text-gray-600 mb-8">
              Don't miss out on the opportunity to connect with fellow entrepreneurs, investors, and
              professionals at our upcoming events.
            </p>
