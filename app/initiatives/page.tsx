...
export const metadata: Metadata = {
  ...
  description:
    "Explore OPEN Silicon Valley's initiatives supporting the community",
};
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-600 mb-8">
              OPEN Silicon Valley has launched several initiatives to support
              specific needs within our community and create lasting impact.
            </p>
          </div>
        </div>
        <div
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                Through our initiatives, we've made a significant impact on the
                entrepreneurial ecosystem in Silicon Valley and beyond.
              </p>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                Hear from entrepreneurs and professionals who have benefited
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div className="flex flex-col md:flex-row gap-6">
                  ...
                  <div className="md:w-3/4">
                    <p className="text-gray-600 italic mb-4">
                      "SV Connect helped me find mentors and collaborators who
                      were instrumental in the growth of my startup. The
                      connections I made through this platform have been
                      invaluable."
                    </p>
                    <div className="font-semibold">Sarah Khan</div>
                    <div className="text-sm text-gray-500">
                      Founder & CEO, TechSolutions
                    </div>
                  </div>
                </div>
              </Card>
              ...
              <Card className="border-gray-100 shadow-sm p-8">
                <div className="flex flex-col md:flex-row gap-6">
                  ...
                  <div className="md:w-3/4">
                    <p className="text-gray-600 italic mb-4">
                      "Startup Connect provided my early-stage startup with the
                      resources and mentorship we needed to refine our business
                      model and secure seed funding. I'm grateful for the
                      support."
                    </p>
                    <div className="font-semibold">Ahmed Ali</div>
                    <div className="text-sm text-gray-500">
                      Co-founder, HealthTech Innovations
                    </div>
                  </div>
                </div>
              </Card>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg text-gray-600 mb-8">
              There are many ways to get involved with our initiatives, whether
              you're an entrepreneur, investor, professional, or student.
            </p>
