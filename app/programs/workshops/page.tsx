...
import { ArrowRight, Calendar, Users, BookOpen, Lightbulb, Target } from 'lucide-react'
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-600 mb-8">
              Join our hands-on workshops led by industry experts to learn new skills, network with
              professionals, and accelerate your career growth.
            </p>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                Explore our diverse range of workshops designed to help you grow professionally and
                personally.
              </p>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                Join our upcoming workshops and take the next step in your professional journey.
              </p>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <div className="bg-linear-to-r from-primary/5 via-white to-primary/5 rounded-2xl p-8 border border-primary/10">
              <h2 className="text-3xl font-bold mb-4">Want to Host a Workshop?</h2>
              <p className="text-lg text-gray-600 mb-8">
                Share your expertise with our community by hosting a workshop. We provide the
                platform, you bring the knowledge.
              </p>
              <Button asChild size="lg" className="rounded-full">
