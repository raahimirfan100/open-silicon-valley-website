...
export const metadata: Metadata = {
  ...
  description: 'Advance your career with our comprehensive development programs and resources',
}
...
export default function CareerDevelopmentPage() {
  const programs = [
    {
      ...
      description: 'One-on-one guidance to help you achieve your professional goals.',
      icon: Target,
      details: [
    ...
    },
    {
      ...
      description: 'Enhance your professional skills with targeted training programs.',
      icon: GraduationCap,
      details: [
  ...
  const testimonials = [
    {
      quote: 'The career coaching program helped me land my dream job at a leading tech company.',
      name: 'Sarah Ahmed',
    ...
    {
      quote: 'The networking events opened doors to opportunities I never knew existed.',
      name: 'Imran Malik',
    ...
    {
      quote: 'The skill development workshops gave me the confidence to pursue leadership roles.',
      name: 'Aisha Khan',
      role: 'Team Lead',
      ...
      <section className="relative py-20 bg-linear-to-b from-primary/10 to-white overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-6">Career Development</h1>
            <p className="text-xl text-gray-600 mb-8">
              Take your career to the next level with our comprehensive development programs. From
              skill enhancement to networking opportunities, we provide the resources you need to
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                Comprehensive career development programs designed to help you achieve your
                professional goals.
              </p>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                Hear from professionals who have advanced their careers with our programs.
              </p>
            </div>
          ...
          <div className="max-w-4xl mx-auto text-center">
            <div className="bg-linear-to-r from-primary/5 via-white to-primary/5 rounded-2xl p-8 border border-primary/10">
              ...
              <p className="text-lg text-gray-600 mb-8">
                Join our career development programs and take the next step in your professional
                journey.
              </p>
              <Button asChild size="lg" className="rounded-full">
