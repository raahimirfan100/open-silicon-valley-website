...
export const metadata: Metadata = {
  ...
  description: "Join OPEN Silicon Valley's Young Professionals program for early to mid-career professionals",
}
...
export default function YoungProfessionalsPage() {
  const benefits = [
    ...
    },
    {
      ...
      description: "Connect with industry leaders, potential mentors, and peers at your career stage.",
    },
    {
      icon: TrendingUp,
      title: "Skill Enhancement",
      description: "Participate in training sessions and workshops to develop both technical and soft skills.",
    },
    {
      icon: Users,
  ...
  const events = [
    {
      ...
      description: "Casual networking events held monthly at various tech companies and co-working spaces.",
      frequency: "Monthly",
    },
    {
      title: "Professional Development Workshops",
      description: "Skills-focused workshops covering leadership, communication, and technical expertise.",
      frequency: "Quarterly",
    },
    {
      title: "Industry Panel Discussions",
      description: "Panels featuring successful professionals discussing career paths and industry trends.",
      frequency: "Bi-monthly",
    },
    {
      title: "Mentorship Program",
      description: "Structured mentorship program pairing young professionals with experienced leaders.",
      frequency: "Ongoing",
    },
  ]
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
              Designed for early to mid-career professionals looking to accelerate their growth, expand their network,
              and make meaningful contributions to the Pakistani-American business community in Silicon Valley.
            </p>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-lg text-gray-600 mb-6">
                  Our Young Professionals program is tailored for individuals who are 3-10 years into their careers and
                  are looking to take the next step in their professional journey. Whether you're in tech, finance,
                  consulting, or any other field, this program provides the resources and connections you need.
                </p>
                <p className="text-lg text-gray-600 mb-8">
                  Members gain access to exclusive networking events, professional development workshops, mentorship
                  opportunities, and a supportive community of like-minded professionals.
                </p>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                Our Young Professionals program offers comprehensive support for your career advancement and
                professional growth.
              </p>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                Regular events and programs designed specifically for young professionals to learn, network, and grow.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <Card className="border-gray-100 shadow-sm">
                <CardContent className="p-6 text-center">
                  ...
                  <p className="text-gray-600 italic mb-4">
                    "The mentorship I received through OPEN SV's Young Professionals program was instrumental in my
              ...
              <Card className="border-gray-100 shadow-sm">
                <CardContent className="p-6 text-center">
                  ...
                  <p className="text-gray-600 italic mb-4">
                    "The networking events helped me find my co-founder and launch my fintech startup. The community
              ...
              <Card className="border-gray-100 shadow-sm">
                <CardContent className="p-6 text-center">
                  ...
                  <p className="text-gray-600 italic mb-4">
                    "The professional development workshops gave me the leadership skills I needed to transition into
                    management."
                  </p>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg text-gray-600 mb-8">
              Join our Young Professionals program and connect with a community that will support your growth and
              success.
            </p>
            <Button asChild size="lg" className="rounded-full">
              <Link href="https://opensv.wildapricot.org/join-us">
