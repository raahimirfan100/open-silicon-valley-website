        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-600 mb-8">
              Have questions about our programs or want to get involved with OPEN Silicon Valley?
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
              <div>
                ...
                <p className="text-gray-600 mb-8">
                  Fill out the form below and we'll get back to you as soon as possible. We're here
                  to answer any questions you may have about our programs, events, or how to get
                  involved.
                </p>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg text-gray-600 mb-8">
              Follow us on social media to stay updated with our latest events, programs, and
              announcements.
            </p>
            ...
            <div className="space-y-6">
              <div className="bg-white rounded-xl shadow-xs border border-gray-100 p-6">
                ...
                <p className="text-gray-600">
                  You can become a member by visiting our membership page and filling out the
                  application form. We offer different membership types to cater to professionals at
              ...
              <div className="bg-white rounded-xl shadow-xs border border-gray-100 p-6">
                ...
                <p className="text-gray-600">
                  We welcome volunteers who are passionate about our mission. You can apply to
                  volunteer by visiting our Volunteer page and filling out the application form. We
                  have various volunteer opportunities available.
                </p>
              </div>
              ...
              <div className="bg-white rounded-xl shadow-xs border border-gray-100 p-6">
                ...
                <p className="text-gray-600">
                  We offer various sponsorship opportunities for our events. Please contact us at
                  info@opensv.org for more information about sponsorship packages and benefits.
                </p>
              </div>
              ...
              <div className="bg-white rounded-xl shadow-xs border border-gray-100 p-6">
                ...
                <p className="text-gray-600">
                  We're always looking for inspiring speakers for our events. Please send your
                  speaker proposal to info@opensv.org with the subject line "Speaker Proposal" and
                  include details about the speaker and proposed topic.
                </p>
              </div>
            </div>
          </div>
